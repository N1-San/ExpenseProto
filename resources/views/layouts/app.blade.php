        ...
        <aside class="w-64 h-screen bg-gray-900 text-white flex flex-col fixed top-0 left-0">
            ...
            @auth
                ...
                <nav class="flex-1 p-4 space-y-2">
                    ...
                    <a href="{{ route('loans') }}"
                        class="flex items-center gap-2 p-2 rounded {{ request()->routeIs('loans') ? 'bg-gray-700' : 'hover:bg-gray-700' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <a href="{{ route('admin.index') }}"
                        class="flex items-center gap-2 p-2 rounded {{ request()->routeIs('admin.index') ? 'bg-gray-700' : 'hover:bg-gray-700' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
