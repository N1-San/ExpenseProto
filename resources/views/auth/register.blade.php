...
<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="name" class="block text-gray-400 mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="email" class="block text-gray-400 mt-1 w-full" type="email" name="email" :value="old('email')" required autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password" class="block text-gray-400 mt-1 w-full"
                            type="password"
                            name="password"
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password_confirmation" class="block text-gray-400 mt-1 w-full"
                            type="password"
