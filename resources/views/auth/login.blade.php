...
<x-guest-layout>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div>
                ...
                <x-text-input id="email" class="block text-gray-900 mt-1 w-full" type="email" name="email" :value="old('email')" required
            ...
            <div class="mt-4">
                ...
                <x-text-input id="password" class="block text-gray-900 mt-1 w-full" type="password" name="password" required
